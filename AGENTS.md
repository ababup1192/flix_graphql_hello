...
src/http/              手書き HTTP/1.1、Router（純粋なルート表。Method / Pattern / Route / Match、`find` は上から当てて 405 の Allow を表の順で出す）、Cors（`Cors.wrap` が preflight と 404 / 503 込みの CORS ヘッダ。Allow-Methods は表から）
