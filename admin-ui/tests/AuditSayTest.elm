...
sentences =
    [ ( ( "member.invited", "member", "hana@example.com" ), """{"role":"editor"}""", "hana@example.com を 編集者 で招待した" )
    , ( ( "member.role_changed", "member", "7" ), """{"role":"owner"}""", "7 の役割を 管理者 にした" )
    ...
    , ( ( "type.created", "type", "blogs" ), "{}", "API blogs を作った" )
    , ( ( "type.updated", "type", "blogs" ), """{"before":{"apiId":"blogs","name":"ブログ"}}""", "API blogs を直した" )
    ...
    , ( ( "field.added", "field", "uxprobes.title" ), "{}", "uxprobes に title を足した" )
    , ( ( "field.updated", "field", "uxprobes.title" ), fieldBefore, "uxprobes の title を直した" )
    , ( ( "field.removed", "field", "uxprobes.title" ), fieldBefore, "uxprobes の title を削除した" )
    , ( ( "fields.reordered", "type", "uxprobes" ), """{"before":{"fields":["title","body"]}}""", "API uxprobes のフィールドを並び替えた" )
    , ( ( "project.visibility_changed", "project", "default" ), """{"before":"private","after":"public"}""", "公開範囲を 非公開 → 公開 にした" )
    , ( ( "webhook.created", "webhook", "w1" ), webhook, "Webhook Slack 通知（hooks.slack.com）を作った" )
    , ( ( "webhook.updated", "webhook", "w1" ), before webhook, "Webhook Slack 通知（hooks.slack.com）を直した" )
    ...
    , ( ( "entry.unpublished", "entry", "4dda8b954371" ), """{"typeApiId":"blogs","version":1}""", "API blogs のコンテンツ 4dda8b954371 の公開を終えた（版 1）" )
    , ( ( "entry.deleted", "entry", "4dda8b954371" ), """{"typeApiId":"blogs","version":2}""", "API blogs のコンテンツ 4dda8b954371 を削除した（版 2）" )
    , ( ( "entry.published", "entry", "4dda8b954371" ), """{"typeApiId":"blogs","version":4,"scheduledFor":"2026-09-10T13:00:00Z"}""", "API blogs のコンテンツ 4dda8b954371 を予約どおり公開した（版 4、予約は 2026-09-10 22:00 JST）" )
